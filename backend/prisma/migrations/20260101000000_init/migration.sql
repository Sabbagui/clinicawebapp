...
-- AddForeignKey
ALTER TABLE "medical_records" ADD CONSTRAINT "medical_records_finalizedById_fkey" FOREIGN KEY ("finalizedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
